...
<div class="flex flex-col gap-6">
    ...
    <div class="flex flex-col gap-2 text-center">
        ...
        <p class="text-sm text-gray-600">Ingresa tus datos para crear tu cuenta</p>
    </div>
    ...
    <div class="text-center text-sm text-gray-600">
        ...
        <a href="{{ route('login') }}" wire:navigate class="font-semibold text-sena-green-600 hover:text-sena-green-700 transition-colors duration-200 ml-1">
            Iniciar sesión
        </a>
    </div>
</div>
