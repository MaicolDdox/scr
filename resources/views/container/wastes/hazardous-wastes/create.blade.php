...
<div class="max-w-3xl mx-auto bg-white p-8 rounded-2xl shadow-md">
    <h2 class="text-2xl font-bold text-gray-800 mb-6">Registrar Residuo Peligroso</h2>
    ...
    <form action="{{ route('HazardousWaste.store') }}" method="POST" class="space-y-5">
        @csrf
        ...
        <div>
            ...
            <input type="text" name="generating_unit" id="generating_unit" value="{{ old('generating_unit') }}"
        ...
        <div>
            ...
            <input type="text" name="waste_name" id="waste_name" value="{{ old('waste_name') }}"
        ...
        <div>
            ...
            <input type="text" name="hazard_characteristic" id="hazard_characteristic" value="{{ old('hazard_characteristic') }}"
        ...
        <div>
            ...
            <select name="physical_state" id="physical_state"
                ...
                <option value="Gaseoso" {{ old('physical_state') == 'Gaseoso' ? 'selected' : '' }}>Gaseoso</option>
                <option value="Pasta" {{ old('physical_state') == 'Pasta' ? 'selected' : '' }}>Pasta</option>
            </select>
        </div>
        ...
        <div>
            ...
            <input type="text" name="registered_by" id="registered_by" value="{{ old('registered_by') }}"
